...
newfile = "C:\\Users\\592186\\Documents\\Python_study\\"+"image.jpg"#creating new file location as a variable
os.remove(newfile)

import wget
wget.download(url)#using Wget we are downloading pic from that page mentioned in url variable 
oldfile = "C:\\Users\\592186\\Documents\\Python_study"+"\\"+img_date+".jpg"#creating old file location as an variable
